// <copyright file="ColorExtension.cs" company="the-prism">
...
namespace Prism.Soundboard
{
    ...
    public static class ColorExtension
    {
        ...
        private static ResourceDictionary accentResources;

        /// <summary>Create an accent color</summary>
        ...
        public static void CreateAccentColors(this Color color)
        {
            ...
            if (accentResources != null)
            {
                accentResources.AddResources(color);
            }
